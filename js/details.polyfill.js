...
; (function (global) {
    ...
    GOVUK.details = {
        ...
        /**
         * Test to see if a browser supports a given HTML tag, e.g. <details>.
         * Method borrowed from: http://ryanmorr.com/determine-html5-element-support-in-javascript/
         *
         * @param  {String} tag     The element you want to test for, e.g. 'details'
         * @returns {boolean}       Whether the current browser supports the elemtn or not.
         */
        isElementSupported: function (tag) {
        ...
        addDetailsPolyfill: function (list, container) {
            // Don't add the polyfill if the browser already supports the element
            if (GOVUK.details.isElementSupported('details')) {
                return false;
            }
